layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'sex', title: '性别', minWidth:50, align:'center'},
            {field: 'comId', title: '社区编号', align:'center',minWidth:150},
            {field: 'userPhone', title: '用户电话', align:'center',minWidth:150},
            {field: 'ecPhone', title: '紧急联系电话', align:'center',minWidth:150},
            {
                field: 'vc', title: '是否接种疫苗', align: 'center', templet: function (d) {
                    return formatterState(d.vc);
                }
            },
            {field: 'health', title: '健康状态', align:'center',minWidth:150},
    ...
    /*是否接种疫苗*/
    function formatterState(vc) {
        if (vc == 1) {
            return "<div style='color: red'>未接种</div>";
        } else if (vc == 2) {
            return "<div style='color: green'>已接种</div>";
        } else {
